...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'og:image', content: 'https://packwares.com/og-image.png' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: 'https://packwares.com/og-image.png' }],
